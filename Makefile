...
win:
	$(DOCKER) $(MAKE) -C installer/windows OUTFILE=$(OUTFILE) APPNAME=$(APPNAME) A40=$(A40) A30=$(A30) A40MOD_ONLY=$(A40MOD_ONLY) A50=$(A50) A50Z=$(A50Z) WM1A=$(WM1A) ZX300=$(ZX300) DMPZ1=$(DMPZ1) USERDATA_FILENAME=$(USERDATA_FILENAME)
