...
build: prepare
	...
	$(MAKE) -C installer MODEL=nw-a40 USERDATA_FILENAME=$(USERDATA_FILENAME)
...
win:
	$(DOCKER) $(MAKE) -C installer/windows OUTFILE=$(OUTFILE) APPNAME=$(APPNAME) A40=$(A40) A30=$(A30) USERDATA_FILENAME=$(USERDATA_FILENAME)
